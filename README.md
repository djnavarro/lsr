...
[![Codecov test
coverage](https://codecov.io/gh/djnavarro/lsr/graph/badge.svg)](https://app.codecov.io/gh/djnavarro/lsr)
<!-- badges: end -->
...
Compared to base R’s `t.test()`, the output labels every component in
plain English and automatically reports Cohen’s *d* alongside the test
result.
