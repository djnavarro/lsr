...
8. ~~**pkgdown site**~~ – **Complete.** Structured Reference section in
   ...
   See PLAN.md for details.
9. ~~**CRAN submission preparation**~~ – **Complete.** Version bumped to
   1.0.0; `LazyLoad` removed; `Language: en-GB` added; Description rewritten;
   `inst/CITATION` removed; `inst/WORDLIST` added; NEWS.md finalised; spelling,
   URL, `R CMD check --as-cran`, rhub, win-builder, and reverse-dependency
