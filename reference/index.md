...
- [`aad()`](https://lsr.djnavarro.net/reference/aad.md) : Mean (average)
...
- [`colCopy()`](https://lsr.djnavarro.net/reference/copy.md)
  [`rowCopy()`](https://lsr.djnavarro.net/reference/copy.md) : Copies a
...
- [`maxFreq()`](https://lsr.djnavarro.net/reference/mode.md)
  [`modeOf()`](https://lsr.djnavarro.net/reference/mode.md) : Sample
  mode
